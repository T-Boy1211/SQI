...
const Navbar = () => {
  return (
      <nav className="bg-stone-950 text-white flex flex-col px-5 fixed top-0 left-0 w-full">
        ...
        <ul className="flex justify-end items-center mt-[-50] space-x-5 text-white  relative">
          <li className="relative group">
            ...
            <ul className='absolute border border-t-blue-800 border-3 left-0 w-40 bg-gray-500 text-white rounded-lg shadow-lg opacity-0 group-hover:opacity-100 group-hover:translate-y-0 transform -translate-y-3 transition-all duration-200 ease-in-out pointer-events-none group-hover:pointer-events-auto'>
            <li>
          ...
          <li className="relative group">
            ...
            <ul className='absolute border border-t-blue-800 border-3 left-0 w-40 bg-gray-500 text-white rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto'>
            <li>
